...
Endpoint collections (inputs and outputs) may be accessed directly without requiring device or entity interaction at all. See <doc:SwiftMIDIIO-Endpoints> for more information.  
