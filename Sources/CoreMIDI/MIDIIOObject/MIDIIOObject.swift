...
// swiftformat:disable wrapFunctionBodies wrapPropertyBodies
...
public protocol MIDIIOObject: Sendable {
    ...
    /// Return as ``AnyMIDIIOObject``, a type-erased representation of a SwiftMIDI object conforming
    /// to ``MIDIIOObject``.
...
// swiftformat:enable wrapFunctionBodies wrapPropertyBodies
