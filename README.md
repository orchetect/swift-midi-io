...
Extension for [SwiftMIDI](https://github.com/orchetect/swift-midi) adding user-friendly CoreMIDI I/O on Apple platforms supporting MIDI 1.0 and MIDI 2.0.
...
See the [online documentation](https://swiftpackageindex.com/orchetect/swift-midi-io/main/documentation) for this repository and its [Examples](Examples) folder.
